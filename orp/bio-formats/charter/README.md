...
This document formalizes the governance for the Bio-Formats OME
...
The Chair's role is to act as a coordinator and facilitator for the group's activities
and discussions. The Chair holds no additional authority over other PSC members.

The current Chair is [Melissa Linkert (Glencoe Software)](https://github.com/melissalinkert).
